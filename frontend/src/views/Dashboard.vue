<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-[1600px] mx-auto p-6">
      ...
      <header class="mb-8">
        <div
          class="flex flex-col md:flex-row justify-between items-center gap-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4"
        >
...
const exportToExcel = async () => {
  if (!startDate.value || !endDate.value) {
    alert('Please select dates before exporting.')
    return
  }
